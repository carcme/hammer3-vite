const bookingPageText = {
  en: {
    ...
    bookNow: "BOOK YOUR MYSTERY NIGHT NOW!",
    ...
    email: "Email",
    phone: "Telephone",
    comments: "Additional Comments / Requirements",

    preivew: "Order Preview",
  ...
  de: {
    ...
    bookNow: "BUCHEN SIE JETZT IHRE MYSTERY-NACHT!",
    ...
    email: "Email",
    phone: "Telefon",
    comments: "Zusätzliche Kommentare / Anforderungen",

    preivew: "Bestellvorschau",
    ...
    balance: "Der Restbetrag wird am selben Tag ausgezahlt",
    incTaxes: "inkl. Steuern",
